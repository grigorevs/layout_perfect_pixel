export const description = `Depending on the input, this can result in using a lot of processing power 
          and time. The whole process would take approximately 5 seconds to return a result to the client. Keep in
...
export const post = `Our initial approach went like this: The web application would read a .csv file
...
export const info = `Skilled in React Native, iOS and backend, Toni has a demonstrated knowledge of the
